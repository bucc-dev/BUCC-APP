...
import 'package:bucc_app/screens/home/events/widget/no_events.dart';
...
class EventsScreen extends StatelessWidget {
  ...
  static const bool noEvents = false;
  static ValueNotifier<List<bool>> isExpanded =
      ValueNotifier(List.generate(3, (index) => false));

//! SCROLL CONTROLLER
  static final ScrollController _scrollController = ScrollController();
  @override
  Widget build(BuildContext context) => noEvents
      ? const NoEventsScheduled()
